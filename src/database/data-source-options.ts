...
import {AiImportLogSource20260923010000} from "./migrations/20260923010000-ai-import-log-source";
...
export function buildDataSourceOptions(overrides: Partial<BetterSqlite3DataSourceOptions> = {}): BetterSqlite3DataSourceOptions {
    return {
        ...
        entities: ENTITIES,
        migrations: [InitSchema20260921000000, SummaryInsights20260923000000, AiImportLogSource20260923010000],
