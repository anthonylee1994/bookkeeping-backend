...
import {at, authHeader, createTransaction, registerAndLogin} from "./helpers/fixtures";
...
describe("summaries insight", () => {
    ...
    async function seed(fixture: Awaited<ReturnType<typeof registerAndLogin>>): Promise<void> {
        await createTransaction(dataSource, fixture.userId, fixture.accountId, 0, 100_000, at(2026, 9, 16, 9), null, null, null, 0);
        await createTransaction(dataSource, fixture.userId, fixture.accountId, 1, 40_000, at(2026, 9, 16, 12), fixture.expenseCategoryId, null, null, 0);
    }
